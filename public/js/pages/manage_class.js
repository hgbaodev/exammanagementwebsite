                            ...
                            <div class="block block-rounded">
                                <div class="block-header block-header-default">
                                    ...
                                    <div class="block-options">
                                        <button type="button" class="btn btn-sm btn-alt-primary" data-id="${element.malop}">Edit</button>
                                        <button type="button" class="btn btn-sm btn-alt-danger" data-id="${element.malop}">Delete</button>
                                    </div>
                                </div>
