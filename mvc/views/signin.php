...
<body>
    ...
    <div id="page-container">
        ...
        <main id="main-container">
            <!-- Page Content -->
            <div class="bg-image" style="background-image: url('./public/media/photos/photo28@2x.jpg');">
                            ...
                            <div class="w-100">
                                ...
                                <div class="row g-0 justify-content-center">
                                    <div class="col-sm-8 col-xl-4">
                                        <form class="js-validation-signin" action="be_pages_auth_all.html"
                                            method="POST">
                                            <div class="mb-4">
                                                <input type="text"
                                        ...
                                        <a class="btn btn-alt-secondary me-1 mb-3 w-100"><img alt="Logo"
                                                src="./public/media/svg/google-icon.svg" style="height:15px;margin-right:20px">Đăng nhập với Google</a>
                                    </div>
                                </div>
                                <!-- END Sign In Form -->
                            </div>
