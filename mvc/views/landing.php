...
<body>
    ...
    -->
    <div id="page-container" class="sidebar-dark side-scroll page-header-fixed page-header-light main-content-boxed">
      ...
      -->
                                ...
                                <ul class="nav-main-submenu nav-main-submenu-right">
                                    ...
                                    <li class="nav-main-item">
                                        <a class="nav-main-link" data-toggle="theme"
                                            data-theme="./public/css/themes/amethyst.min.css" href="#">
                                    ...
                                    <li class="nav-main-item">
                                        <a class="nav-main-link" data-toggle="theme"
                                            data-theme="./public/css/themes/city.min.css" href="#">
                                    ...
                                    <li class="nav-main-item">
                                        <a class="nav-main-link" data-toggle="theme"
                                            data-theme="./public/css/themes/flat.min.css" href="#">
                                    ...
                                    <li class="nav-main-item">
                                        <a class="nav-main-link" data-toggle="theme"
                                            data-theme="./public/css/themes/modern.min.css" href="#">
                                    ...
                                    <li class="nav-main-item">
                                        <a class="nav-main-link" data-toggle="theme"
                                            data-theme="./public/css/themes/smooth.min.css" href="#">
        ...
        <main id="main-container">
            <!-- Hero -->
            <div class="bg-image" style="background-image: url('./public/media/photos/photo36@2x.jpg');">
            ...
            <div class="content py-4">
                ...
                <div class="row fs-sm pt-4">
                    ...
                    <div class="col-sm-6 order-sm-1 py-1 text-center text-sm-start">
                        <a class="fw-semibold" href="https://1.envato.market/AVD6j" target="_blank">OneUI 5.5</a> &copy;
